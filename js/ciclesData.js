export const ciclesData = {
  ...
  '<div class="curs">',
    ...
    '<ul>',
      ...
      '<li>Llenguatges de marques i sistemes de gestió de la informació</li>',
      '<li>Programació</li>',
      '<li>Sistemes informàtics</li>',
      '<li>Anglès tècnic (GS)</li>',
      '<li>Itinerari personal per a l\'ocupabilitat I</li>',
      '<li>Projecte intermodular de desenvolupament d\'aplicacions web (I)</li>',
    '</ul>',
  '</div>',
  ...
  '<div class="curs">',
    '<h4>2n curs</h4>',
    '<ul>',
      '<li>Desenvolupament web en entorn client</li>',
      '<li>Desenvolupament web en entorn servidor</li>',
      '<li>Desplegament d\'aplicacions web</li>',
      '<li>Disseny d\'interfície web</li>',
      '<li>Empresa i iniciativa emprenedora</li>',
      '<li>Itinerari personal per a l\'ocupabilitat II</li>',
      '<li>Projecte intermodular de desenvolupament d\'aplicacions web (II)</li>',
      '<li>Mòdul optatiu</li>',
      '<li>Digitalització aplicada al sistema productiu (GS)</li>',
      '<li>Sostenibilitat aplicada al sistema productiu</li>',
      '<li>Formació en centres de treball (FCT)</li>',
